        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Calificaciones_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Productoxposts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Productoxposts_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Productoxposts_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productoxposts_PostId",
                table: "Productoxposts",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Productoxposts_ProductoId",
                table: "Productoxposts",
                column: "ProductoId");
        }
